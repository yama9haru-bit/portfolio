...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: '競合調査・市場分析レポート',
    description:
      '顧客の業務課題をヒアリングから分析し、年間504時間削減の自動化提案を作成',
    clientValue:
      '顧客の業務課題をヒアリングから分析し、年間504時間削減の自動化提案を作成できる',
  ...
  },
  {
    ...
    category: 'コンテンツ自動化パイプライン',
    description:
      '議事録からのインサイト抽出、リマインダーボット、業務フロー自動化など社内SaaSのAI-DXを幅広く担当',
    clientValue:
      '議事録からのインサイト抽出、リマインダーボット、業務フロー自動化など、社内SaaSのAI-DXを幅広く担当できる',
  ...
  // ── AI-driven ビジネス構築 ──
  {
    ...
    description:
      'AIを使ってビジネスアイデアを発見し、コンテンツ化し、実際に受注・売上につなげた実績',
    clientValue:
      'AIを使ってビジネスアイデアを発見し、コンテンツ化し、実際に受注・売上につなげた実績がある',
  ...
  },
  {
    ...
    category: 'AI-driven ビジネス構築',
    description:
      '営業活動自体をAI-nativeに設計・運用。アイデア発掘から企画立案、顧客相談、受注までのプロセスをシステム化',
    clientValue:
      '営業活動自体をAI-nativeに設計・運用している。アイデア発掘から企画立案、顧客相談、受注までのプロセスをシステム化済み',
